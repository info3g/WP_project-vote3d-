...
a.downloadable_media i {
margin-right: 5px;
}
a.downloadable_media:hover{
color: #fff;
}</style>
<div class="rtmedia-container rtmedia-single-container">
	<div class="rtm-lightbox-container clearfix">
		...
		if ( have_rtmedia() ) : rtmedia();
			...
			//echo "<pre>"; print_r($rtmedia_media);
			?>
			<div id="rtmedia-single-media-container"
				...
				<?php if ( ! $rt_ajax_request ) { ?>
					...
					<a class="downloadable_media" href="<?php echo $rtmedia_media->guid; ?>" download><i class="icon-download"></i>Download file</a>
				...
				<?php } else { ?>
					...
					<div class='rtm-ltb-action-container clearfix'>
						...
						<div class="rtmedia-actions rtmedia-author-actions rtm-item-actions">
							<a class="download_media" href="<?php echo $rtmedia_media->guid; ?>" download>Download file</a>
							<?php rtmedia_actions(); ?>
			...
			<div class="rtmedia-scroll">
				<?php if ( $rt_ajax_request ) { ?>
					...
					<?php } else{?>
						Please 
					<a href="<?php echo esc_url( home_url( '/' ) ); ?>" id="test" target="_self" class="widget_sp_image-image-link" title="join-vote3d" rel="">Login</a>
					/ <a href="/register" id="test" target="_self" class="widget_sp_image-image-link" title="join-vote3d" rel="">Register</a> to comment.
					<?php }  ?>
