	...
	$( document ).on( 'click', '.rtmedia-page-link', function( e ) {
		...
		if ( $( '#rtMedia-upload-button' ).length > 0 ) {
			...
			uploaderObj.uploader.bind( 'UploadComplete', function( up, files ) {
				$.magnificPopup.open({
					items: {
						src: '<div class="rtmedia-gallery-alert-container"><div class="rtmedia-gallery-message-box"><span class="rtmedia-success">Admin will approve your media in 24-48 hours</span></div></div>',
						type: 'inline'
					}
				});
				setTimeout(function(){ $.magnificPopup.close(); },3e3);
				//alert('Admin will approve your image in 24-48 hours');
				activity_id = -1;
